...
labels = [
    ...
    "Betula pubescens", "Salix alba 'Sericea", "Populus tremula",
    "Ulmus glabra", "Sorbus aucuparia", "Salix sinerea", "Populus",
    "Tilia", "Sorbus intermedia", "Fagus silvatica"
]
        ...
        if image_file is not None:
            ...
            with c2:
                ...
                if os.path.exists(model_path):
                    ...
                    st.markdown("[Click here to learn more about these species!](https://www.google.com/search?q={}+leaf)".format(search))
